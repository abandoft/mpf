...
scalar、numeric array、logical array 或 range selector，执行线性/多维覆盖、扩容、单轴删除与 N 维
页扩容。两个目标都会在提交前验证 selector 与 replacement；不可结构恢复零 extent、stride、view
和 ownership 的统一 NDArray ABI 仍在建设中。

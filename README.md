...
- 当前 0.3.5 开发线为 158 项内部测试、48 个差分 case 和 59 项 CTest；另有持续 fuzz smoke、可选 Clang/libFuzzer 与绑定版本号的编译性能 JSON 发布门禁；生产代码行覆盖率实测 89.00%（17619/19796），高于 85% 硬门槛。0.3.4 的封版数据保留在 changelog。

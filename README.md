...
- 当前 0.3.5 开发线为 153 项内部测试、48 个差分 case 和 59 项 CTest；另有持续 fuzz smoke、可选 Clang/libFuzzer 与绑定版本号的编译性能 JSON 发布门禁；生产代码行覆盖率实测 88.54%（16453/18583），高于 85% 硬门槛。0.3.4 的封版数据保留在 changelog。

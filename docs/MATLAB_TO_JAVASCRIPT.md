...
fuzz、架构隔离和第 36 项性能预算共同验证该边界。矩形/复数 sparse 与动态 sparse shape 继续失败关闭。
...
- [ ] 随后纵切面：sparse rectangular/complex、动态 sparse shape、病态特定解精确对齐、其余 numeric class、跨函数动态 NDArray shape ABI

...
- [ ] 随后纵切面：sparse logical 算术/归约、power/rectangular/complex、动态 sparse shape、病态特定解精确对齐、其余 numeric class、跨函数动态 NDArray shape ABI
